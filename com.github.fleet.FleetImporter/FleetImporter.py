        ...
        try:
            ...
            with urllib.request.urlopen(
                ...
                if response.getcode() == 200:
                    ...
                    # Find title matching software_title and version
                    for title in titles:
                        if title.get("name") == software_title and title.get("version") == version:
                            # Check if software_package exists and hash matches
                            software_package = title.get("software_package")
                            if software_package and software_package.get("sha256") == hash_sha256:
                                return {
                    ...
                    # Not found
                    self.output(f"Package not found: {software_title} {version} with hash {hash_sha256[:16]}...")
                    return None
                else:
